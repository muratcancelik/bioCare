...
--
-- Dumping events for database 'eva'
--

--
-- Dumping routines for database 'eva'
--
/*!50003 DROP PROCEDURE IF EXISTS `personel_ekleme` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `personel_ekleme`(IN personelid INT, IN personelad Varchar(50), IN personelsoyad Varchar(50),
IN personeltc varchar(50),IN personeltelno varchar(11), IN personeldepartman INT, IN personelmaas int)
begin
insert into personel(p_ID,p_Ad,p_Soyad,p_TcKimlik,p_TelNo,p_Departman,p_Maas) values(personelid,personelad,personelsoyad,personeltc,personeltelno,
(select (d_Id) from departman),
(select (m_Id) from maas));
end ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `satis_ekleme_islemi` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `satis_ekleme_islemi`(IN satis_id INT,IN urun_id int,IN adet INT,IN musteri_id int, IN personel_id int ,fiyat INT,tarih date)
begin
	insert into Satis(s_ID,s_UrunId,s_Adet,s_MusteriId,s_PersonelId,s_Fiyat,s_Tarih) 
    values(satis_id,urun_id,adet,musteri_id,personel_id,fiyat, tarih);
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `urun_ekleme` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `urun_ekleme`(IN urun_id INT,IN urun_ad varchar(100), IN urun_marka INT,
IN urun_aciklama varchar(250),
IN urun_kategori INT , IN urun_stok INT,urun_fiyat INT)
begin
	insert into urun(u_Id,u_Ad,u_Marka,u_Aciklama,u_Kategori,u_Stok,U_Fiyat)
    values (urun_id,urun_ad,urun_marka,urun_aciklama,urun_kategori,urun_stok,urun_fiyat);
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `urun_ekleme_islemi` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `urun_ekleme_islemi`(IN urun_id INT,IN urun_ad varchar(100), IN urun_marka INT,
IN urun_aciklama varchar(250),
IN urun_kategori INT , IN urun_stok INT,urun_fiyat INT)
begin
	insert into urun(u_Id,u_Ad,u_Marka,u_Aciklama,u_Kategori,u_Stok,U_Fiyat)
    values (urun_id,urun_ad,(select (marka_id) from marka),urun_aciklama,
    (select (k_Id) from kategori),urun_stok,(select (f_Id) from Fiyat));
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
